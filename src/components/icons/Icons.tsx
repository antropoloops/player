...
export { ReactComponent as FullscreenExitIcon } from "./fullscreen_exit-24px.svg";
export { ReactComponent as FullscreenIcon } from "./fullscreen-24px.svg";
export { ReactComponent as LoginIcon } from "./login-24px.svg";
